...
Esta guía explica cómo agregar una nueva **tool** al agente de ObraCero. Cada tool es una capacidad ejecutable que el agente puede invocar durante una conversación.
